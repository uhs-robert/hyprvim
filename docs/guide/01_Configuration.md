...
- `history = true` recalls earlier entries with the arrow keys. Each prompt keeps its own file under `$XDG_STATE_HOME/hyprvim/history`, trimmed to `history_size` entries (default 200)
